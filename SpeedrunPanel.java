...
public class SpeedrunPanel extends GamePanel {
    ...
    private void removeSpeedUpPotion() {
        if (getSpeedUpPotionBtn() != null) {
            main.getPotions().remove(getSpeedUpPotion());
            super.remove(getSpeedUpPotionBtn());
            super.repaint();
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawImage(getGaugeBar().getImage(), 20, 70, null);
    ...
    private void endGame() {
        if (!isGameEnded) {
            ...
            main.getEndPanel().setCoinScore(getCoinScore()); // Ensure the coin score is set
