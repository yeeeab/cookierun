...
public class GamePanel extends JPanel {
    ...
    public GamePanel(JFrame superFrame, CardLayout cl, Object o) {
        ...
        // Load the coin potion image
        ImageIcon potionIcon2 = new ImageIcon("img/store/potion3.png");
        ...
        coinPotion = new CoinPotion(resizedPotionImage2, 40, 0, resizedPotionIcon2.getIconWidth(), resizedPotionIcon2.getIconHeight(), 1);

        // Initialize coinPotionBtn
        coinPotionBtn = new JButton(resizedPotionIcon2);
        ...
        coinPotionBtn.setBounds((superFrame.getWidth() - buttonWidth2) / 2 + 100, superFrame.getHeight() - buttonHeight2 - 40, buttonWidth2, buttonHeight2); // Position the button at the bottom right
